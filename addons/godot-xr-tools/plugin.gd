...
func _enter_tree():
	...
	_define_project_setting(
		"godot_xr_tools/input/grip_threshold", TYPE_FLOAT, PROPERTY_HINT_RANGE, "0.2,0.8,0.05", 0.7
	)

	# Add input haptics_scale to the project settings
	_define_project_setting(
		"godot_xr_tools/input/haptics_scale", TYPE_FLOAT, PROPERTY_HINT_RANGE, "0.0,1.0,0.1", 1.0
	)
	...
	_define_project_setting(
		"godot_xr_tools/input/default_snap_turning", TYPE_BOOL, PROPERTY_HINT_NONE, "", true
	)
